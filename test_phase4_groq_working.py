#!/usr/bin/env python3
"""
Test script to verify Phase 4 is hitting the Groq API correctly with proper model.
"""
...
def test_groq_api_connection():
    """Test that Phase 4 can successfully connect to Groq API."""
    print("=" * 60)
    print("Phase 4 Groq API Connection Test")
    print("=" * 60)
    ...
    model = os.environ.get("XAI_MODEL", "llama-3.1-8b-instant")  # Use Groq model
    ...
    if not api_key:
        ...
        print("XAI_API_KEY=your_groq_api_key_here")
        return False
    ...
    try:
        ...
        print("OK Groq API call successful!")
        ...
        if using_fallback:
            print("\nWARNING Using fallback recommendations (not from Groq API)")
            print("This suggests the Groq API call failed or returned invalid response.")
        else:
            print("\nSUCCESS Using AI recommendations from Groq API!")
        
        print("\n" + "=" * 60)
        print("OK Phase 4 Groq API test completed successfully!")
        print("=" * 60)
...
def test_api_key_validation():
    ...
    try:
        ...
        api_key = os.environ.get("XAI_API_KEY")
        base_url = os.environ.get("XAI_BASE_URL", "https://api.groq.com/openai/v1")
        model = os.environ.get("XAI_MODEL", "llama-3.1-8b-instant")
...
def main():
    """Run all tests."""
    print("TEST Phase 4 Groq API Test Suite")
    print("This test verifies that Phase 4 is successfully hitting the Groq API")
    ...
    if success:
        print("\nALL TESTS PASSED!")
        print("Phase 4 is successfully hitting the Groq API")
    else:
